...
# Read and compile the TEAL programs for the token_transfer contract
approval_program_path = "approval.teal"  # Update path if needed
...
clear_program_path = "clear.teal"  # Update path if needed
