...
global_schema = StateSchema(num_uints=1, num_byte_slices=0)  # Adjust based on contract needs
local_schema = StateSchema(num_uints=0, num_byte_slices=0)   # Adjust based on contract needs
